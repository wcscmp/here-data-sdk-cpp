...
DataRepository::DataResponseWithNetworkStats DataRepository::GetVersionedData(
...
DataRepository::DataResponseWithNetworkStats DataRepository::GetBlobData(
  ...
  DataResponseWithNetworkStats storage_response;
  ...
  if (service == kBlobService) {
    ...
    storage_response = DataResponseWithNetworkStats(volatile_blob.MoveResult());
  }
